...
return [
  ...
  'resolvers' => [
    ...
    'request_context' => OwenIt\Auditing\Resolvers\DumpResolver::class,
    'action_context' => OwenIt\Auditing\Resolvers\DumpResolver::class,
  ],
  ...
  'driver' => 'database', // Changed back to database to maintain existing functionality
  ...
  'queue' => [
    'enable' => true, // Enable queue for high-traffic scenarios
